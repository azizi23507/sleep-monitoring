...
### Step 4: Get Authentication Token (For Pi Only)

**Note:** Only needed for sending sensor data (Pi devices). Frontend doesn't need authentication!
...
### Step 5: Send Test Sensor Data (Requires Token)

**This is the ONLY endpoint that requires authentication!**
